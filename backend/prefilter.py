...
# Bot isimleri - mesajlari atla
BOT_NAMES = {
    "prime duyuru", "bi risk", "bnj risk", "monobot", "livecallkuyruk",
    "bonusholigan", "hesapli bot", "onay bot", "chat score bot",
    "sahte avcisi", "teknik domain hit bot", "bisorgu",
}

def is_bot_message(sender_name: str) -> bool:
    return sender_name.lower() in BOT_NAMES
